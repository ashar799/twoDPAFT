multiposteriorchineseAFT = function(c,Y1,Y2,D1,D2,That, F,K, beta, ro, r, si,sig2.dat,gmmx1, gmmx2, regy1, regy2) {
  ...
  for(l in 1:N)  {
    ...
    if(length(which(cminus==temp))==0)  
    {
      ...
      gmmx1$S[active[kminus]+1,1:D1,1:D1] <- gmmx1$S[temp,1:D,1:D]
